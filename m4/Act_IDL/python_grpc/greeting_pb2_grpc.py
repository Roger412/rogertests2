...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayGoodbye = channel.unary_unary(
                '/greeting.Greeter/SayGoodbye',
                request_serializer=greeting__pb2.GoodbyeRequest.SerializeToString,
                response_deserializer=greeting__pb2.GoodbyeReply.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SayGoodbye': grpc.unary_unary_rpc_method_handler(
                    servicer.SayGoodbye,
                    request_deserializer=greeting__pb2.GoodbyeRequest.FromString,
                    response_serializer=greeting__pb2.GoodbyeReply.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def SayGoodbye(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/greeting.Greeter/SayGoodbye',
            greeting__pb2.GoodbyeRequest.SerializeToString,
            greeting__pb2.GoodbyeReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
